As a administrator, I want to add new student records, so that system can keep track of student information accurately {
	Basic Flow {
    	...
    	(System) 4. When add new student record, the system shall check whether user have permessio. (functional)
    	(System) 5. When add new student, the system shall check whether id is existed. (functional)
    	(System) 6. When add new student, the system shall stores new student record in database for future reference. (functional)
	}
	Alternative Flow {
...
As a administrator, I want to manage user permissions, so that system maintains data security {
	Basic Flow {
		...
		(System) 4. When change user permessions, the system shall check whether user have permession. (non functional)
...
As a administrator, I want to edit existing student records, so that I can keep student information accurate {
	Basic Flow {
		...
		(System) 4. When edit student records, the system shall check whether user have permession. (non functional)
...
As a teacher, I want to access existing student records, so that I can view their personal information {
	Basic Flow {
		...
		(System) 4. When select a student, the system shall display student information. (functional)
	}
}
...
As a teacher, I want to update student grades, so that I can keep their academic records up to date {
	Basic Flow {
		...
		(System) 4. When update student grades, the system shall check whether user have permession. (non functional)
		(System) 5. When update student grades, the system shall check grade is valid. (functional)
		(System) 6. When update student grades, the system shall updates student record in database. (functional)
	} Alternative Flow {
...
As a administrator, I want to delete student records, so that outdated or irrelevant information can be removed {
	Basic Flow {
		...
		(System) 4. When delete student, the system shall check whether user have permession. (non functional)
...
As a student, I want to view my class schedule, so that I can plan my day effectively {
	Basic Flow {
    	...
    	(System) 3. The system shall displays class schedule. (functional)
	}
	Alternative Flow {
...
As a student, I want to check my course schedule, so that I know my classroom {
	Basic Flow {
		...
		(System) 3. When student selects Course Schedule option, the system shall display student class schedule with details on time and location. (functional)
	}
	Alternative Flow {
